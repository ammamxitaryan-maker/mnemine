...
import { 
  ...
  getLastDrawResults, 
  getLotteryHistory 
} from '../lotteryControllerImproved';
  ...
  describe('buyLotteryTicket', () => {
    ...
    it('should handle insufficient funds', async () => {
      const mockUser = {
        id: 'user1',
        telegramId: '123456789',
        wallets: [{ id: 'wallet1', currency: 'CFM', balance: 5 }], // Less than ticket cost
      };
    ...
    it('should handle missing CFM wallet', async () => {
      const mockUser = {
        id: 'user1',
        telegramId: '123456789',
        wallets: [{ id: 'wallet1', currency: 'BTC', balance: 100 }], // No CFM wallet
      };
