...
const possiblePaths = [
  path.join(__dirname, '../public'),           // server/public (primary for single service)
  path.join(__dirname, '../../client/dist'),   // client/dist (fallback for development)
  path.join(__dirname, '../../dist'),          // project/dist (legacy)
  path.join(__dirname, '../../public'),        // project/public (legacy)
  path.join(__dirname, '../dist'),             // server/dist (fallback)
];
