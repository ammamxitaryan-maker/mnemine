...
import { depositFunds, withdrawFunds, claimEarnings } from '../../controllers/walletControllerImproved';
import { getLotteryStatus, buyLotteryTicket } from '../../controllers/lotteryControllerImproved';
