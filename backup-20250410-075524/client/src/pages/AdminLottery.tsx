          ...
          <CardContent>
            ...
            <div>
                ...
                <div className="text-lg font-bold text-gold">
                  {lotteryData?.lottery.jackpot.toFixed(2) || '0.00'} CFM
                </div>
            </div>
            <div>
        ...
        {/* Winner Selection Form */}
          ...
          <Card className="bg-gray-900 border-gray-700 mb-4">
            ...
            <CardContent>
              ...
              <div>
                  <label className="block text-sm text-gray-300 mb-2">Prize Amount (CFM)</label>
                <input
                  type="number"
                  step="0.01"
                    value={prizeAmount}
                  ...
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <div className="text-right">
                      <div className="text-gold font-mono">
                        {participant.cfmBalance.toFixed(2)} CFM
                      </div>
                      {participant.isWinner && (
                        <div className="text-green-400 text-sm">
                          Won: {participant.totalWinnings.toFixed(2)} CFM
                        </div>
                      )}
                    </div>
        </div>
                          ...
                          {ticket.isWinner ? (
                            <>
                              <span className="text-green-400">
                                Winner: {ticket.prizeAmount?.toFixed(2)} CFM
                              </span>
                              <Button
                                size="sm"
                                variant="outline"
