          ...
          <Card className="bg-gray-900 border-gray-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-gold">
                {(stats?.finances.totalInvested || 0).toFixed(2)} CFM
              </div>
            </CardContent>
          </Card>
          ...
          <Card className="bg-gray-900 border-gray-700">
            ...
            <CardContent>
              <div className="text-2xl font-bold text-purple-400">
                {(stats?.today.payouts?.amount || 0).toFixed(2)} CFM
              </div>
              <p className="text-xs text-gray-400">
                      ...
                      >
                        ...
                        <div className="text-right">
                          <div className="text-gold font-mono">
                            {user.totalInvested.toFixed(2)} CFM
                          </div>
            ...
            <Card className="bg-gray-900 border-gray-700">
              <CardHeader>
                <CardTitle className="flex items-center">
                  ...
                  CFM ⇄ CFMT Exchange Rate Management
                </CardTitle>
                <CardDescription>Set the base exchange rate for CFM to CFMT conversion</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="bg-gray-800 p-4 rounded-lg">
                  <div className="text-sm text-gray-400 mb-1">Current Exchange Rate</div>
                  <div className="text-3xl font-bold text-gold">
                    1 CFM = {currentRate.toFixed(4)} CFMT
                  </div>
                ...
                <div className="bg-blue-900/20 border border-blue-700 p-3 rounded text-sm text-blue-300">
                  <strong>Note:</strong> The exchange rate affects all CFM ⇄ CFMT swaps.
