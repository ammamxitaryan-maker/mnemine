...
export const DIRECT_CFM_WITHDRAWAL_DISABLED = true; // Прямой вывод CFM запрещен
...
export const SLOT_EXTENSION_COST = 1.0; // в CFM
...
export const DIVIDEND_BASE_RATE = 0.15; // 0.15 * CFM V_i
...
// Lottery Constants
export const LOTTERY_TICKET_COST = 1.0; // 1 CFM per ticket
...
export const MINIMUM_WITHDRAWAL_CFMT = 3.0; // Минимальная сумма вывода CFMT
