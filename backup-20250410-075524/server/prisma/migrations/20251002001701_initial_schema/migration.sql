...
CREATE TABLE "SwapTransaction" (
    "id" TEXT NOT NULL,
    "userId" TEXT NOT NULL,
    "cfmAmount" DOUBLE PRECISION NOT NULL,
    "cfmtAmount" DOUBLE PRECISION NOT NULL,
