...
**Impact**: Admin can control CFM-CFMT conversion rate.
...
- [x] CFM → CFMT swap works
- [x] CFMT → CFM swap works
- [x] Toast notifications appear
- [x] Balances update correctly

**Claim Validation**:
- [x] Balance < 3 CFM → error toast
- [x] Balance >= 3 CFM → claim works
...
- Minimum investment: 3 CFM as specified
...
2. Tap to expand
3. Select direction (CFM→CFMT or CFMT→CFM)
4. Enter amount
5. See preview
6. Tap "Swap"
