...
import { RANKED_REFERRAL_COMMISSIONS_L1, RANKED_REFERRAL_COMMISSIONS_L2, RANKED_REFERRAL_COMMISSIONS_L3, RANK_SLOT_RATE_BONUS_PERCENTAGE, REFERRAL_COMMISSIONS } from 'shared';
