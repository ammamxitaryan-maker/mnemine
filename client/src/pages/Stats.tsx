...
const Stats = () => {
  ...
  const statItems = [
    { key: 'totalEarnings', label: t('totalEarnings'), icon: DollarSign, unit: 'CFM', colorClass: 'text-emerald' },
    { key: 'totalInvested', label: t('totalInvested'), icon: TrendingUp, unit: 'CFM', colorClass: 'text-cyan' },
